pipeline {
    ...
    environment {
        ...
        GKE_CLUSTER_NAME = 'jenkins-cluster' // Update with your GKE cluster name
        GKE_PROJECT_ID = 'pivotal-data-452009-k8' // Update with your GCP project ID
        GKE_ZONE = 'us-central1' // Update with your GKE cluster zone
        GIT_REPO_URL = 'https://github.com/naveenavuladoddi/new-kubernet-repo.git' // Update with your Git repository URL
